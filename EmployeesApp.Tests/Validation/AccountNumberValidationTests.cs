...
namespace EmployeesApp.Tests.Validation
{
    public class AccountNumberValidationTests
    {
        ...
        [Fact]
        public void IsValid_ValidAccountNumber_ReturnTrue()
            => Assert.True(_validation.IsValid("123-4543234566-23"));
        ...
        public void IsValid_AccountNumberFirstPartWrong_WithInlineData_ReturnsFalse(string accountNumber)
